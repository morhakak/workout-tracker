    ...
    <div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg">
      ...
      >
        ...
        <div class="flex flex-col">
          <label for="work-name" class="mb-1 text-sm text-at-light-green"
            >Workout Name</label
          >
          <input
            type="text"
        ...
        <!-- Workout Type -->
        <div class="flex flex-col">
          <label for="work-type" class="mb-1 text-sm text-at-light-green"
            >Workout Type</label
          >
          <select
            @change="workoutChanging"
            id="workout-type"
            class="p-2 text-gray-500 focus:outline-none"
            required
            v-model="workoutType"
